...
class PresentationForm extends React.Component {
    constructor(props) {
        super(props);
        // this.state are the fields a user will see when they fill out the form online
        this.state = {
            presenterName: '',
            presenterEmail: '',
            companyName: '',
    ...
    async handleSubmit(event) {
        ...
        // triple dots -- copies all of the properties and values from this.state into a new object
